...
export default abstract class AbstractViewHelper<A extends Dict<unknown>> {
    ...
    protected templateVariableContainer: VariableProvider;
    ...
    public setContext(engine: Engine, renderer: Renderer, document: Document) {
        this.engine = engine;
        this.renderer = renderer;
        this.document = document;
        this.variableProvider = renderer.getVariableProvider();
    }
    ...
    protected abstract render(): Promise<HTMLElement>;
}
